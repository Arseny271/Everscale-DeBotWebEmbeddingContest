...
contract ExampleContract is Debot {
    ...
    function scatter(uint8 count) public {
        ...
        for (uint8 i = 0; i < count - 2; i++) {
            ...
            ExampleContract(dst).transfer{value: val, bounce: false, flag: 3}(val);
        ...
        ExampleContract(dst).transfer{value: val, bounce: true, flag: 3}(val);
        m_recipients.push(Recipient(dst, val));
    ...
    function start() public override {
        Terminal.print(tvm.functionId(_start), "Hello!");        
    }
